...
def generate_version_header_file(version: str, repo_name: str) -> str:
...
def git_commit(file_path:str, repo_name:str)->bool:
...
def main()->None:
    ...
    repo_name = "TM9101"
    tag_name = generate_version_header_file(version, repo_name)

    if not git_commit(VERSION_FILE_PATH,repo_name):
